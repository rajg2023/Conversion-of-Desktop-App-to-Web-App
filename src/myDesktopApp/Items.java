 ...
 *//*
  ...
  *//*
	public Items() {
		...
		lblItemDetails.setBounds(0, 0, 495, 39);
		...
		btnNewButton_5.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				list_Qnty.add(str3);
				textArea_totalCosts.setText(listprice);

				textArea_totalItems.setText("" + list_cart.getItemCount());

				//Setup sum and arraylist later
		...
		lblCashier.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblCashier.setBounds(505, 2, 64, 39);
		details_panel.add(lblCashier);

		JTextArea textAreaCashierName = new JTextArea();
		textAreaCashierName.setFont(new Font("Monospaced", Font.BOLD, 13));
		textAreaCashierName.setEditable(false);
		textAreaCashierName.setBackground(SystemColor.activeCaption);
		textAreaCashierName.setBounds(569, 9, 144, 22);
		details_panel.add(textAreaCashierName);
